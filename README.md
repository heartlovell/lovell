# Offensive Security & Adversary Simulation Portfolio

> Building real-world offensive security tooling to understand how modern attacks work — and how they’re detected.

---

## 👋 Introduction

I’m an IT professional building a hands-on offensive security portfolio focused on **adversary simulation, pentesting fundamentals, and detection engineering**.
...
- Offensive Security & Pentesting Fundamentals  
- Malware Tradecraft (Lab-Only, Educational)  
- Command-and-Control (C2) Architecture  
- Detection Engineering with Splunk  
- MITRE ATT&CK–Mapped Adversary Techniques  
- Red Team & Purple Team Methodology  
...
- **Languages:** Python, C++  
- **Security Tooling:** Splunk, Sysmon, HTB Labs  
- **Concepts:** C2, beaconing, tasking, OPSEC tradeoffs, detection logic  
...
- How does this attack technique actually work?
- What telemetry does it generate?
- How would a defender detect it?
- Where would detection fail?
- How would an attacker adapt?

This mindset guides every repo in this portfolio.

---

## ⚖️ Ethics & Disclaimer

All work documented here is conducted **solely in authorized lab environments** for educational and research purposes.  
No projects are intended for unauthorized use or real-world exploitation.

---

## 🚀 Career Direction

I’m actively preparing for **entry-level pentesting, purple team, or offensive security engineering roles**, where technical curiosity, ethical testing, and strong fundamentals matter more than buzzwords.

If you’re reviewing this portfolio as part of a hiring process, I’d be happy to walk through any project in detail.
